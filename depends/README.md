...
RISC-V known issue: gcc-7.3.0 and gcc-7.3.1 result in a broken `test_paymastercoin` executable (see https://github.com/adminpaymastercoin/paymastercoin/pull/13543),
...
options will be passed to paymastercoin's configure. In this case, `--disable-wallet`.
