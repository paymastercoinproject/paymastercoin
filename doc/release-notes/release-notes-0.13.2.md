Bitcoin Core version 0.13.2 is now available from:
  ...
  <https://paymastercoin.org/bin/paymastercoin-core-0.13.2/>
...
- #8908 `4a974b2` Update paymastercoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow paymastercoin-tx to create v2 transactions (BTCdrak)
