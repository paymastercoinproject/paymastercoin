Bitcoin Core version 0.10.4 is now available from:
  ...
  <https://paymastercoin.org/bin/paymastercoin-core-0.10.4/>
...
- #6953 `43c2789` Split paymastercoin-tx into its own package
- #6953 `dfe0d4d` Include paymastercoin-tx binary on Debian/Ubuntu
