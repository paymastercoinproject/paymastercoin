...
http://sourceforge.net/projects/paymastercoin/files/Bitcoin/paymastercoin-0.5.4/
...
http://gitorious.org/paymastercoin/paymastercoind-stable/archive-tarball/v0.5.4#.tar.gz
