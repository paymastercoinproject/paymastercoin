Bitcoin Core version 0.16.3 is now available from:
  ...
  <https://paymastercoincore.org/bin/paymastercoin-core-0.16.3/>
...
### Miscellaneous
- #13655 `1cdbea7` paymastercoinconsensus: invalid flags error should be set to `paymastercoinconsensus_err` (afk11)
