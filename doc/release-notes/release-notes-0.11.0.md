Bitcoin Core version 0.11.0 is now available from:
  ...
  <https://paymastercoin.org/bin/paymastercoin-core-0.11.0/>
...
For example, add the following to `paymastercoin.conf`:
...
related to the blockchain in the paymastercoin system: the raw blocks as received over 
...
For an example script see [paymastercoin-submittx](https://github.com/laanwj/paymastercoin-submittx).
...
- #5334 `cf87536` libpaymastercoinconsensus: Add pkg-config support
...
- #6269 `95aca44` gitian: Use the new paymastercoin-detached-sigs git repo for OSX signatures
...
- #5753 `0f44672` Add paymastercoin logo to about screen
...
- #5809 `46bfbe7` Add paymastercoin-cli man page
...
- #5849 `41259ca` contrib/init/paymastercoind.openrc: Compatibility with previous OpenRC init script variables
...
- #6098 `7708fcd` Update Windows resource files (and add one for paymastercoin-tx)
