Bitcoin version 0.7.0 is now available for download at:
  http://sourceforge.net/projects/paymastercoin/files/Bitcoin/paymastercoin-0.7.0/

We recommend that everybody running prior versions of paymastercoind/Bitcoin-Qt
...
source-only tarballs/zipballs directly from there:
  https://github.com/adminpaymastercoin/paymastercoin/tarball/v0.7.0  # .tar.gz
  https://github.com/adminpaymastercoin/paymastercoin/zipball/v0.7.0  # .zip
...
in your terminal, then install the paymastercoin-qt package:
  sudo apt-get install paymastercoin-qt
...
(on Mac) or
Code:
paymastercoind/paymastercoin-qt
(on Linux).
...
Core paymastercoin handling and blockchain database
...
* Ensure a changed paymastercoin unit immediately updates all GUI elements that use units
...
* (Windows only): enable ASLR and DEP for paymastercoin-qt.exe
* (Windows only): add meta-data to paymastercoin-qt.exe (e.g. description)
...
* Bash programmable completion for paymastercoind(1)
