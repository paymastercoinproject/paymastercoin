# `paymastercoin.conf` Configuration File
...
-- | -- | --
Windows | `%APPDATA%\Bitcoin\` | `C:\Users\username\AppData\Roaming\Bitcoin\paymastercoin.conf`
Linux | `$HOME/.paymastercoin/` | `/home/username/.paymastercoin/paymastercoin.conf`
macOS | `$HOME/Library/Application Support/Bitcoin/` | `/Users/username/Library/Application Support/Bitcoin/paymastercoin.conf`
