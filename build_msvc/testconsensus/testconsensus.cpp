...
// paymastercoin includes.
#include <..\src\script\paymastercoinconsensus.h>
...
int main()
{
    std::cout << "paymastercoinconsensus version: " << paymastercoinconsensus_version() << std::endl;
    ...
    auto op0Result = paymastercoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, paymastercoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
