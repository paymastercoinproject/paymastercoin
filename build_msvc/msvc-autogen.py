...
libs = [
    'libpaymastercoin_cli',
    'libpaymastercoin_common',
    'libpaymastercoin_crypto',
    'libpaymastercoin_server',
    'libpaymastercoin_util',
    'libpaymastercoin_wallet_tool',
    'libpaymastercoin_wallet',
    'libpaymastercoin_zmq',
    'bench_paymastercoin',
    'libtest_util',
]
        ...
        with open(vcxproj_filename + '.in', 'r', encoding='utf-8') as vcxproj_in_file:
            with open(vcxproj_filename, 'w', encoding='utf-8') as vcxproj_file:
                vcxproj_file.write(vcxproj_in_file.read().replace(
                    '@SOURCE_FILES@\n', content))
    copyfile(os.path.join(SOURCE_DIR,'../build_msvc/paymastercoin_config.h'), os.path.join(SOURCE_DIR, 'config/paymastercoin-config.h'))
