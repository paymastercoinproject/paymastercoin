...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " paymastercoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  paymastercoin-tx [options] <hex-tx> [commands]  Update hex-encoded paymastercoin transaction\n" +
            "or:     paymastercoin-tx [options] -create [commands]   Create hex-encoded paymastercoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded paymastercoin transaction
