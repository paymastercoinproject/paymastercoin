...
bool CWallet::AddToWallet(const CWalletTx& wtxIn, bool fFlushOnClose)
{
    ...
    if (!strCmd.empty())
    {
        ...
        // https://github.com/adminpaymastercoin/paymastercoin/pull/13339#issuecomment-537384875
        // A few ways it could be implemented in the future are described in:
        // https://github.com/adminpaymastercoin/paymastercoin/pull/13339#issuecomment-461288094
...
{
    // If wallet doesn't have a chain (e.g paymastercoin-wallet), lock can't be taken.
    ...
    while (block_height && !fAbortRescan && !chain().shutdownRequested()) {
        ...
        if (chain().findBlock(block_hash, &block) && !block.IsNull()) {
            ...
            if (!locked_chain->getBlockHeight(block_hash)) {
                ...
                // https://github.com/adminpaymastercoin/paymastercoin/pull/14711#issuecomment-458342518
                         ...
                         int& nChangePosInOut, std::string& strFailReason, const CCoinControl& coin_control, bool sign)
{
    ...
    int nBytes;
    {
        ...
        LOCK(cs_wallet);
        {
            ...
            // change transaction isn't always pay-to-paymastercoin-address
...
DBErrors CWallet::LoadWallet(bool& fFirstRunRet)
{
    ...
    // tx status. If lock can't be taken (e.g paymastercoin-wallet), tx confirmation
 ...
 * https://paymastercointalk.org/?topic=54527, or
 * https://github.com/adminpaymastercoin/paymastercoin/pull/1393.
 */
...
int CWalletTx::GetBlocksToMaturity() const
{
    ...
    //PMCTODO Some wallets are still not abandoning coinstakes correctly
...
void CWallet::StakePMCs(bool fStake, CConnman* connman, CTxMemPool* mempool)
{
    ::StakePMCs(fStake, this, connman, mempool, stakeThread);
}

void CWallet::StartStake(CConnman *connman, CTxMemPool* mempool)
{
    m_enabled_staking = true;
    StakePMCs(true, connman, mempool);
}
