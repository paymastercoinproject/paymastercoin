...
//!       https://github.com/adminpaymastercoin/paymastercoin/pull/15934/files#r337691812)
using SettingsValue = UniValue;

//! Stored paymastercoin settings. This struct combines settings from the command line
