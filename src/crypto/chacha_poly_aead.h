...
/* A AEAD class for ChaCha20-Poly1305@paymastercoin.
 *
 ...
 *
 * The chacha20-poly1305@paymastercoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@paymastercoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@paymastercoin are relatively fast in
