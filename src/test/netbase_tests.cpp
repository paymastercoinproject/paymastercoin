...
{
    BOOST_CHECK(TestSplitHost("www.paymastercoincore.org", "www.paymastercoincore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.paymastercoincore.org]", "www.paymastercoincore.org", -1));
    BOOST_CHECK(TestSplitHost("www.paymastercoincore.org:80", "www.paymastercoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.paymastercoincore.org]:80", "www.paymastercoincore.org", 80));
