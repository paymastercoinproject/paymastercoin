    ...
    mapper(nullptr)
{
    ...
    ui->paymastercoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->paymastercoinAtStartup);
    ...
    ui->paymastercoinAtStartup->setToolTip(ui->paymastercoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->paymastercoinAtStartup->setText(ui->paymastercoinAtStartup->text().arg(PACKAGE_NAME));
...
{
    /* Main */
    mapper->addMapping(ui->paymastercoinAtStartup, OptionsModel::StartAtStartup);
