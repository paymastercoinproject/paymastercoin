...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a PaymasterCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and PaymasterCoin : URIs)"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your PaymasterCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified PaymasterCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a paymastercoin: URI"));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        tooltip = tr("%n active connection(s) to PaymasterCoin network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
