...
class BackwardsCompatibilityTest(BitcoinTestFramework):
    ...
    def setup_nodes(self):
        ...
        self.add_nodes(self.num_nodes, extra_args=self.extra_args, versions=[
            ...
            self.options.paymastercoind,
            self.options.paymastercoind,
            releases_path + "/v0.19.0.1/bin/paymastercoind",
            releases_path + "/v0.18.1/bin/paymastercoind",
            releases_path + "/v0.17.1/bin/paymastercoind"
        ], binary_cli=[
            self.options.paymastercoincli,
            self.options.paymastercoincli,
            releases_path + "/v0.19.0.1/bin/paymastercoin-cli",
            releases_path + "/v0.18.1/bin/paymastercoin-cli",
            releases_path + "/v0.17.1/bin/paymastercoin-cli"
        ])
    ...
    def run_test(self):
        ...
        # RPC loadwallet failure causes paymastercoind to exit, in addition to the RPC
