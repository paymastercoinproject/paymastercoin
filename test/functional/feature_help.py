...
"""Verify that starting paymastercoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start paymastercoin with -h for help text")
        ...
        self.log.info("Start paymastercoin with -version for version information")
        ...
        self.log.info("Start paymastercoind with -fakearg to make sure it does not start")
