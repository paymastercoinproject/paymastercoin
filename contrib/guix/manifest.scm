...
(define* (make-paymastercoin-cross-toolchain target
                                  #:key
...
(packages->manifest
 (list ;; The Basics
       ...
       (make-paymastercoin-cross-toolchain "i686-linux-gnu")
       (make-paymastercoin-cross-toolchain "x86_64-linux-gnu")
       (make-paymastercoin-cross-toolchain "aarch64-linux-gnu")
       (make-paymastercoin-cross-toolchain "arm-linux-gnueabihf")
       ...
       (make-paymastercoin-cross-toolchain "riscv64-linux-gnu"
