...
EXCLUDE = [
    # auto generated:
    'src/qt/paymastercoinstrings.cpp',
...
Arguments:
    <base_directory> - The base directory of a paymastercoin source code repository.
...
Arguments:
    <file> - A source file in the paymastercoin repository.
"""
