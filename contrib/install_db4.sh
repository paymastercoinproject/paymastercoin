...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the paymastercoin repository."
  exit 1
fi
...
# See https://github.com/adminpaymastercoin/paymastercoin/issues/16064
...
echo 'When compiling paymastercoind, run `./configure` in the following way:'
echo
